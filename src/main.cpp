...
#define BAT_FACTOR        0.979981    // a = y/x, calibration factor, y = real value, e.g 4.2V, x = value calculated, e.g. 4.15V
#define PAN_FACTOR        0.986017    // a = y/x, calibration factor, y = real value, e.g 4.2V, x = value calculated, e.g. 4.15V
